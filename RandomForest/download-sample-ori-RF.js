...
var select1 = ee.FeatureCollection("path/sample-" + At + "-2016_2023-v1-5000-rice");
var select2 = ee.FeatureCollection("path/sample-" + At + "-2016_2023-v1-10000-other_crop");
var select3 = ee.FeatureCollection("path/sample-edge-" + At + "-2016_2023-v1-500-rice");
var select4 = ee.FeatureCollection("path/sample-edge-" + At + "-2016_2023-v1-1000-other_crop");
Map.addLayer(select1, {}, "select1");

for (var yr = 2016; yr <= 2023; yr++) {
  ...
  var chinaProvinces = ee.FeatureCollection("path/to/shp");
